...
public class MainSceneController extends Popup {
    ...
    public void createDock(Bridge.View viewD, Bridge.DockPlacement placement){
        BridgeComponent dock = getBridgeReference().getController(viewD);
        if (placement == Bridge.DockPlacement.Right){
    ...
    public void removeDock(Bridge.View viewD){
        BridgeComponent dock = getBridgeReference().getController(viewD);
    ...
    private void toogleLayersDock(){
        if (toogleLayers.isSelected()){
            createDock(Bridge.View.LayersD, Bridge.DockPlacement.Right);
        }
        else{
            removeDock(Bridge.View.LayersD);
        }
    }
    ...
    private void toogleToolsDock(){
        if (toogleTools.isSelected()){
            createDock(Bridge.View.ToolsD, Bridge.DockPlacement.Left);
        }
        else{
            removeDock(Bridge.View.ToolsD);
        }
    }
